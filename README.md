...
- **Demo project.** This is a portfolio/learning project. It is not operated as a service for
  children and does not knowingly collect data from minors; accounts are for demonstration and
  testing. The moderation system is designed *as if* protecting an all-ages audience.
- **Not affiliated** with any existing game or company. The social-hub genre inspired the mechanics;
  all names, characters, art, and code are original.

## License

TODO — choose a license (e.g. MIT) before publishing.
